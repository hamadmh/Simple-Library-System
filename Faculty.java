...
public class Faculty implements borrower {// The Domain Specific Language Functions are in this class
    private String id;
    ...
    public static borrower[] facultysArray = new borrower[10];
    int index;

    public Faculty(String id, String firstName, String lastName, String department, Date dateOfJoin) {
        this.id = id;
    ...
    public borrower add(borrower member) {
        facultysArray[index++] = member;
        return member;
    }

    @Override
    public void update(Message m) {//The Observer Design Pattern
